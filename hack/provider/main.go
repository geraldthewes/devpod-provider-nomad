...
var checksumMap = map[string]string{
	"./release/devpod-provider-nomad-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-nomad-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-nomad-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-nomad-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-nomad-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
